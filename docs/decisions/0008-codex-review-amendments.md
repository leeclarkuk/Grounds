...
Substring credential matching is ADR-0001 Decision 3. This ADR does not restate it.

### 1. Unusable deficit metrics cannot prove PASS
...
### 3. RunningTaskCount lives in Container Insights
...
### 4. TargetGroup dimension matching
