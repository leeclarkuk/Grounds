...
| Credential leakage                    | Worker-only credentials. Redaction matches access-key ids and presigned URL parameters anywhere in a string, not only at position zero. No credentials in API errors.                                 |
